...
public class patientServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        con=DriverManager.getConnection("jdbc:derby://localhost:1527/user");
        stmt=con.createStatement();
        stmt.executeUpdate("insert into table values('"+n+"','"+p+"')");
        out.print("<h1>Your account is created succesfully</h1>");
        }
        catch(Exception e)
        {
